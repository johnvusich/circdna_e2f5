...
GENOME_DIR="/mnt/scratch/vusichjo/circdna_e2f5/data_repo/mm10"
FASTA="$GENOME_DIR/mm10.fa"
DATA_REPO="/mnt/scratch/vusichjo/circdna_e2f5/data_repo"

# Define the samplesheet, outdir, workdir, and config
SAMPLESHEET="/mnt/scratch/vusichjo/circdna_e2f5/fetchngs_results/samplesheet/samplesheet.csv"
OUTDIR="/mnt/scratch/vusichjo/circdna_e2f5/results"
WORKDIR="/mnt/scratch/vusichjo/circdna_e2f5_work"
CONFIG="/mnt/scratch/vusichjo/circdna_e2f5/icer.config"
LICENSE="/mnt/scratch/vusichjo/circdna_e2f5/mosek_license_dir"
